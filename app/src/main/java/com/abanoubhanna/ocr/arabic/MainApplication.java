...
public class MainApplication extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        // start copy file here, copy ara.trainneddata from assets to external storage ../tessdata/arabic.trainneddata
    ...
    void copyFiles(String fname){
        ...
        try {
            ...
            if(!tessFolder.exists())
                tessFolder.mkdir();
            String tessData = tesspath+"/"+ fname;
